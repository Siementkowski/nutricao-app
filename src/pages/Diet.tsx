  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        ...
        {entry.notes && (
          <span
            ...
            style={{ backgroundColor: 'rgba(124,154,126,0.15)', color: '#5A8A5C', fontWeight: 400 }}
          >
            {entry.notes}
          </span>
        )}
        ...
        {entry.substitutions_json && (
          <span
            ...
            style={{ backgroundColor: '#F7F5F0', color: '#8B8B5A', fontWeight: 400 }}
          >
      ...
      <button
        ...
        style={{
          backgroundColor: state === 'done' ? '#EEF3EE' : state === 'loading' ? '#F7F5F0' : '#FFFFFF',
          color: state === 'done' ? '#5A8A5C' : '#7C9A7E',
          border: `1px solid ${state === 'done' ? '#5A8A5C' : '#7C9A7E'}`,
          fontWeight: 500,
      ...
      <div className="px-5 space-y-3 pb-28">
        {dietEntries.length === 0 ? (
          ...
          >
            ...
            <p className="text-sm mb-1" style={{ color: '#2C2C2C', fontWeight: 500 }}>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span className="text-xs" style={{ color: '#5A8A5C', fontWeight: 500 }}>
