  ...
  return (
    <>
      ...
      >
        ...
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 sticky top-5 bg-white z-10" style={{ borderBottom: '1px solid #EBEBEB' }}>
        ...
        <div className="px-5 py-5 space-y-6 pb-12">
            ...
            >
              {([
                ...
                <div key={key} className="flex items-center justify-between gap-3">
                  <label className="text-sm shrink-0 w-32" style={{ color: '#111111', fontWeight: 400 }}>
                    {label}
                  </label>
                  <div
                  ...
                  >
                    ...
                    />
                    <span className="text-xs" style={{ color: '#999999', fontWeight: 300 }}>kcal</span>
                  </div>
                </div>
              ))}
              ...
              {(() => {
                ...
                return (
                  <div className="flex items-center justify-between pt-1" style={{ borderTop: '1px solid #F5F5F5' }}>
                    <span className="text-xs" style={{ color: '#999999', fontWeight: 300 }}>Total</span>
                    <span className="text-xs" style={{ color: '#111111', fontWeight: 500 }}>{total} kcal</span>
                  </div>
                )
              })()}
              ...
              <button
                ...
                style={{
                  backgroundColor: mealGoalsSaved ? '#E8F5ED' : '#F5F5F5',
                  color: mealGoalsSaved ? '#2D7D46' : '#111111',
                  fontWeight: 500,
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2">
                {([
                  ...
                  <div key={key}>
                    <label className="text-xs block mb-1" style={{ color: '#999999', fontWeight: 300 }}>{label}</label>
                    <div className="rounded-xl px-2 py-2 flex items-center gap-1" style={{ backgroundColor: '#F5F5F5', border: '1px solid #EBEBEB' }}>
                      <input
                        type="number"
                        min="0"
                        ...
                        style={{ color: '#111111', fontWeight: 500 }}
                      />
                      <span className="text-xs shrink-0" style={{ color: '#999999', fontWeight: 300 }}>{unit}</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {/* Sexo */}
              <div>
                <label className="text-xs block mb-1.5" style={{ color: '#999999', fontWeight: 300 }}>Sexo</label>
                <div className="flex gap-2">
                  {(['male', 'female'] as const).map(s => (
                    <button
                      ...
                      style={{
                        backgroundColor: energy.sex === s ? '#2D7D46' : '#F5F5F5',
                        color: energy.sex === s ? '#FFFFFF' : '#111111',
                        border: `1px solid ${energy.sex === s ? '#2D7D46' : '#EBEBEB'}`,
                        fontWeight: 500,
                        transition: 'all 0.15s',
                      }}
                    >
              ...
              {/* Nível de atividade */}
              <div>
                <label className="text-xs block mb-1.5" style={{ color: '#999999', fontWeight: 300 }}>Nível de atividade</label>
                <div className="grid grid-cols-2 gap-2">
                  {ACTIVITY_OPTIONS.map(opt => (
                    <button
                      ...
                      style={{
                        backgroundColor: energy.activity === opt.value ? '#2D7D46' : '#F5F5F5',
                        color: energy.activity === opt.value ? '#FFFFFF' : '#111111',
                        border: `1px solid ${energy.activity === opt.value ? '#2D7D46' : '#EBEBEB'}`,
              ...
              <div className="flex items-center justify-between gap-3">
                <label className="text-sm shrink-0" style={{ color: '#111111', fontWeight: 400 }}>Gasto de treino</label>
                <div className="flex items-center gap-1.5 rounded-xl px-3 py-2" style={{ backgroundColor: '#F5F5F5', border: '1px solid #EBEBEB' }}>
                  <input
                    type="number"
                    min="0"
              ...
              {/* TMB / TDEE preview */}
              {tmb > 0 && (
                <div className="rounded-xl px-4 py-3 flex justify-between" style={{ backgroundColor: '#E8F5ED' }}>
                  <div className="text-center">
                    <p className="text-xs mb-0.5" style={{ color: '#2D7D46', fontWeight: 300 }}>TMB</p>
                    <p className="text-sm" style={{ color: '#111111', fontWeight: 600 }}>{tmb} kcal</p>
                  </div>
                  <div className="w-px" style={{ backgroundColor: '#EBEBEB' }} />
                  <div className="text-center">
                    <p className="text-xs mb-0.5" style={{ color: '#2D7D46', fontWeight: 300 }}>TDEE</p>
                    <p className="text-sm" style={{ color: '#111111', fontWeight: 600 }}>{tdee} kcal</p>
                  </div>
                  <div className="w-px" style={{ backgroundColor: '#EBEBEB' }} />
                  <div className="text-center">
                    <p className="text-xs mb-0.5" style={{ color: '#2D7D46', fontWeight: 300 }}>Total</p>
                    <p className="text-sm" style={{ color: '#111111', fontWeight: 600 }}>{tdee + energy.workout} kcal</p>
                  </div>
                </div>
              )}
              ...
              <button
                ...
                style={{
                  backgroundColor: energySaved ? '#E8F5ED' : '#F5F5F5',
                  color: energySaved ? '#2D7D46' : '#111111',
                  fontWeight: 500,
                  border: '1px solid #EBEBEB',
                  transition: 'all 0.15s',
                }}
          ...
          <section>
            ...
            <div
              ...
              style={{ backgroundColor: '#FFFFFF', border: '1px solid #EBEBEB' }}
            >
              <label className="text-xs block mb-1.5" style={{ color: '#999999', fontWeight: 300 }}>
                ID da planilha
              </label>
              <input
                type="text"
              ...
              />
              <p className="text-xs mb-4" style={{ color: '#999999', fontWeight: 300 }}>
              ...
              <button
                ...
                style={{
                  backgroundColor: syncState === 'loading' ? '#EBEBEB' : '#2D7D46',
                  color: syncState === 'loading' ? '#999999' : '#FFFFFF',
                  fontWeight: 500,
                  transition: 'all 0.15s',
                }}
              >
              ...
              {syncMsg && (
                <div
                  ...
                  style={{
                    backgroundColor: syncState === 'success' ? '#E8F5ED' : '#FBF0EB',
                    color: syncState === 'success' ? '#2D7D46' : '#C4501A',
                    fontWeight: 400,
                  }}
                >
          ...
          <section>
            ...
            >
              {[
                ...
                <div key={key} className="flex items-center justify-between gap-3">
                  <label className="text-sm shrink-0 w-28" style={{ color: '#111111', fontWeight: 400 }}>
                    {label}
                  </label>
                  <div
                    className="flex items-center gap-1.5 rounded-xl px-3 py-2"
              ...
              <button
                ...
                style={{
                  backgroundColor: goalsSaved ? '#E8F5ED' : '#F5F5F5',
                  color: goalsSaved ? '#2D7D46' : '#111111',
                  fontWeight: 500,
                  border: '1px solid #EBEBEB',
                  transition: 'all 0.15s',
                }}
